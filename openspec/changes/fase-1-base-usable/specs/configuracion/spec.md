...
### Requirement: Secciones de la pantalla de configuración en fase 1

La pantalla de configuración SHALL incluir en fase 1 las secciones Perfil,
Tema, General e Instalación. Las secciones Notificaciones y Calendarios del
...
- **WHEN** se abre la pantalla de configuración
- **THEN** aparecen las secciones Perfil, Tema, General e Instalación
...
### Requirement: Sección Perfil

La sección Perfil SHALL permitir editar el nombre, SHALL mostrar el correo
electrónico sin permitir editarlo, y SHALL ofrecer la opción de cambiar la
contraseña.

#### Scenario: El nombre se puede editar y guardar

- **WHEN** se cambia el nombre en la sección Perfil y se guarda
