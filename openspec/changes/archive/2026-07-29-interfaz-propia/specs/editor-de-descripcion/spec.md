...
convertirla en el formato correspondiente en el momento: por ejemplo, escribir
`#` seguido de un espacio al inicio de una línea SHALL producir un título,
nunca el carácter `#` literal. Esta autodetección SHALL ser exclusivamente de
