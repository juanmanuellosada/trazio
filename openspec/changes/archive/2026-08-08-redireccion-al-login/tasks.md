...
- [x] 3.2 Verificar en el navegador: entrar sin sesión a una ruta profunda y confirmar que después de loguearte volvés ahí y no a la bandeja. **Cerrada por decisión del dueño** (2026-08-08): sin verificación en el navegador ni en dispositivo real.
