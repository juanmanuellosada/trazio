...
- [x] 14.12 Usar Trazio un día entero con tareas reales antes de dar la fase por cerrada — le corresponde al dueño del proyecto, no a la implementación
